...
<link href="${ctxStatic}/login/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
<link href="${ctxStatic}/login/css/font-awesome.min.css" type="text/css" rel="stylesheet" />
<link href="${ctxStatic}/login/css/uniform.default.min.css" rel="stylesheet" />
<link href="${ctxStatic}/login/css/jeesite.min.css" type="text/css" rel="stylesheet" />
