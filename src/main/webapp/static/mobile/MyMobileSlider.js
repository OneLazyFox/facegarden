(function($){
    $.fn.myMobileSlider = function(settings){
        var defaultSettings = {
            width: 640, //容器宽度
            height: 320, //容器高度
            during: 5000, //间隔时间
        ...
        return this.each(function(){
            ...
            if(s.width.indexOf('%') > 0){
            	var mywidth = s.width.substring(0,s.width.length-1);
            	moveWidth = document.body.clientWidth * parseFloat(mywidth/100); //滚动宽度
            }else{
            ...
            //初始化焦点容器及按钮
            _this.append('<div class="focus"><div class="focus_div"></div></div>');
            ...
            $(window).bind('resize load', function(){
               ...
               // }
                ...
                oFocusContainer.width(_this.width()).height(_this.height() * 0.07).css({
                    zIndex: 2
                });//设定焦点容器宽高样式
                //_this.fadeIn(300);
            });
            ...
            function mobileSettings(){
                ...
                var iScale = $(window).width() / s.height;
                //正方形图片显示
                _this.height($(window).width()).width($(window).width());
                oMover.css({
